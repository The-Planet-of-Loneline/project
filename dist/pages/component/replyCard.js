...
var ReplyCard = (_temp2 = _class = function (_BaseComponent) {
  ...
  function ReplyCard() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReplyCard.__proto__ || Object.getPrototypeOf(ReplyCard)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.customComponents = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  return ReplyCard;
}(_taroQq.Component), _class.$$events = [], _class.$$componentPath = "pages/component/replyCard", _temp2);
