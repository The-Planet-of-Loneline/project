...
var SecretCard = (_temp2 = _class = function (_BaseComponent) {
  ...
  function SecretCard() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SecretCard.__proto__ || Object.getPrototypeOf(SecretCard)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["textValue"], _this.config = {
      navigationBarTitleText: '孤独星球'
    }, _this.customComponents = ["ReplyCard"], _temp), _possibleConstructorReturn(_this, _ret);
  }
