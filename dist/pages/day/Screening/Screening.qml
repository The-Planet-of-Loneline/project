<template name="renderShowScreen">
    <block>
        ...
        <block qq:elif="{{chosen.which === 1}}">
            <view class="{{oStyle}}">
                <view class="list-extends">
                    <tag qq:key="$loopState__temp2" qq:for="{{loopArray1}}" qq:for-item="details" qq:for-index="index" compid="{{details.$compid__4}}"></tag>
                </view>
        ...
        <block qq:elif="{{chosen.which === 2}}">
            <view class="{{tStyle}}">
                <view class="list-extends">
                    <tag qq:key="$loopState__temp6" qq:for="{{loopArray2}}" qq:for-item="time" qq:for-index="index" compid="{{time.$compid__5}}"></tag>
                </view>
                <view class="detail-time">时间区间（1~24整点）</view>
                <view class="downer">
                    <input class="enter" maxlength="2" placeholder="{{placeHolder[0]}}" placeholder-class="place-enter" value="{{chosen.during[0]}}" bindinput="ifNum" bindchange="onDuring" bindfocus="changeHolder" bindblur="changeHolder" data-e-input-so="this" data-e-input-a-a="{{0}}" data-e-change-so="this" data-e-change-a-a="{{0}}" data-e-focus-so="this" data-e-focus-a-a="{{false}}" data-e-focus-a-b="{{true}}" data-e-blur-so="this" data-e-blur-a-a="{{false}}" data-e-blur-a-b="{{false}}" />
                    <view class="line"></view>
                    <input class="enter" maxlength="2" placeholder="{{placeHolder[1]}}" placeholder-class="place-enter" value="{{chosen.during[1]}}" bindinput="ifNum" bindchange="onDuring" bindfocus="changeHolder" bindblur="changeHolder" data-e-input-so="this" data-e-input-a-a="{{1}}" data-e-change-so="this" data-e-change-a-a="{{1}}" data-e-focus-so="this" data-e-focus-a-a="{{true}}" data-e-focus-a-b="{{true}}" data-e-blur-so="this" data-e-blur-a-a="{{true}}" data-e-blur-a-b="{{false}}" />
                </view>
        ...
        <block qq:elif="{{chosen.which === 3}}">
            <view class="{{oStyle}}">
                <view class="list-extends">
                    <tag qq:key="$loopState__temp8" qq:for="{{loopArray3}}" qq:for-item="place" qq:for-index="index" compid="{{place.$compid__6}}"></tag>
                </view>
...
<block qq:if="{{$taroCompReady}}">
    <view catchtouchmove="handleTouchMove">
        <view class="divide-con">
            <view class="divide shadow-box">
